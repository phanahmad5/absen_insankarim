...
<h1>أهلًا و سهلًا</h1>
        ...
        <div class="page-container">
            <!-- HEADER DESKTOP-->
            <header class="header-desktop"style="background-color:#006400;">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                       ...
                                       <img src="../images/08052024173637WhatsApp Image 2024-05-08 at 22.31.25_19be1631.jpg" alt="" style="width: 30px; height: 30px; vertical-align: middle; margin-right: 5px; border-radius: 15px;">
                                       <?php echo $r['nama']; ?>
                                         </a>
                                         </div>
